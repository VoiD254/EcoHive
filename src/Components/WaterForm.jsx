  ...
  return (
    <div className="relative mb-4">
      <input
        ...
        className={`mt-1 block w-full px-3 py-2 border ${errors[id] ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white dark:text-gray-300 text-black`}
        {...register(id, {
...
const WaterFormModal = ({ isOpen, onClose }) => {
          ...
          <div className="bg-white dark:bg-gray-800 rounded p-8 mb-6">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="text-black dark:text-gray-300 mb-6">
                <h1 className="font-medium text-2xl">Water Plantation</h1>
              </div>
