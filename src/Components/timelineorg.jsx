...
const TimelineIndi = ({ events, color = 'green-600' }) => {
  return (
    <section>
      <div className="bg-white transition-colors duration-500 mx-4 sm:mx-6 md:mx-10 lg:mt-0 sm:mt-10 md:mt-10">
        <div className="w-full sm:px-6 md:px-10 lg:pt-0 items-center flex flex-col lg:h-svh justify-center pb-0 ">
          <div className="flex flex-row justify-left">
            <h1 className="text-2xl text-start font-bold justify-left text-gray-800 capitalize lg:text-3xl dark:text-white pb-10">Organization Process</h1>
          </div>
