        ...
        <div className="max-h-[80vh] overflow-y-auto p-4 md:p-8">
          ...
          <div className="mt-6 space-y-8 md:mt-8">
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+91 1234567890</span>
                    </p>
                    ...
                    <p className="flex items-start -mx-2">
                        ...
                        <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">capybara@gmail.com</span>
                    </p>
                </div>
