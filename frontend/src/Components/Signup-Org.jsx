      ...
      <input
        ...
        {...register(id, {
          ...
          minLength: (type === "password" && {
            ...
            value: 2,
            message: "companyName must be at least 2 characters long",
          }),
          validate: validate,
          onBlur: () => trigger(id),
        })}
...
export function SignupLoginOrg() {
        ...
        {!isLogin && (
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            <LabelInputContainer>
              ...
              <Input id="companyname" placeholder="Company Name" type="text" register={register} errors={errors} trigger={trigger} />
            </LabelInputContainer>
          </div>
        )}
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Organization Email</Label>
          <Input id="email" placeholder="Organization Email" type="email" register={register} errors={errors} trigger={trigger} />
        </LabelInputContainer>
        {!isLogin &&(
          <LabelInputContainer className="mb-4">
