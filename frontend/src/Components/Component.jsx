...
const ComponentsSection = () => {
  return (
    <div className="container px-6 py-10  pb -12 pt-16 mx-6 pr-16" id="features">
      ...
      <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
        <div className="p-8 space-y-3 border-2 border-green-400 dark:border-green-300 rounded-xl">
          ...
          <a href="#" className="inline-flex p-2 text-green-500 capitalize transition-colors duration-300 transform bg-green-100 rounded-full rtl:-scale-x-100 dark:bg-green-500 dark:text-white hover:underline hover:text-green-600 dark:hover:text-green-500">
