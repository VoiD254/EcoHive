...
const MangroveFormModal = ({ isOpen, onClose }) => {
          ...
          <div className="bg-white dark:bg-gray-800 rounded p-8 mb-6">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="text-black dark:text-gray-300 mb-6">
                <h1 className="font-medium text-2xl">Mangrove Plantation</h1>
              </div>
...
MangroveFormModal.propTypes = {
  isOpen: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default MangroveFormModal;
